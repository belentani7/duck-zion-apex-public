...
const evidenceSourceFiles: Record<string, string[]> = {
  ...
  "desktop-capture": ["docs/audit-final.md"],
  "mobile-capture": ["docs/audit-final.md"],
  "route-404": ["client/src/pages/NotFound.tsx"],
  accessibility: ["client/src/index.css", "docs/audit-final.md"],
  "exact-presets": ["shared/production-catalog.ts"],
  "exact-scenes": ["shared/production-catalog.ts"],
  "plugin-sources": ["shared/production-catalog.ts", "docs/audit-final.md"],
  ...
  responsive: ["client/src/index.css", "docs/audit-final.md"],
